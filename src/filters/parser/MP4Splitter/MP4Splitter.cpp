...
#pragma warning (disable : 4541)// 'dynamic_cast' used on polymorphic type '' with /GR-; unpredictable behavior may result
// The MP4Splitter project itself really doesn't need run-time type information at all.
// No rtti functionality is used on classes generated by the project. Please ensure to keep it that way.
// The only dynamic casts issued are on objects generated by the Bento4 project, which does have rtti functionality enabled.
