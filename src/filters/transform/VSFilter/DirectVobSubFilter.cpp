...
REFERENCE_TIME CDirectVobSubFilter::CalcCurrentTime()
{
    ...
    return (rt - 10000i64 * m_SubtitleDelay) * m_SubtitleSpeedMul / m_SubtitleSpeedDiv; // no, it won't overflow if we use normal parameters (int64_t is enough for about 2000 hours if we multiply it by the max: 65536 as m_SubtitleSpeedMul)
}
